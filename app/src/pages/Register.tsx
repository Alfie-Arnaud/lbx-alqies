    ...
    <div className="min-h-screen flex items-center justify-center pt-16">
      <div className="w-full max-w-md px-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type="email" name="email" value={formData.email} onChange={handleChange}
                placeholder="you@example.com" className="input-dark pl-10 w-full" required />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type="text" name="username" value={formData.username} onChange={handleChange}
                placeholder="filmlover" className="input-dark pl-10 w-full" required minLength={3} />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type="text" name="displayName" value={formData.displayName} onChange={handleChange}
                placeholder="Your name" className="input-dark pl-10 w-full" />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type={showPassword ? 'text' : 'password'} name="password" value={formData.password}
                ...
                className="input-dark pl-10 pr-10 w-full" required minLength={6} />
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type={showPassword ? 'text' : 'password'} name="confirmPassword" value={formData.confirmPassword}
                onChange={handleChange} placeholder="••••••••" className="input-dark pl-10 w-full" required />
            </div>
          </div>
        ...
        <p className="text-center text-gray-400">
          ...
          <Link to="/login" className="text-[#E8C547] hover:underline font-medium">Sign in</Link>
        </p>
      </div>
    </div>
  );
